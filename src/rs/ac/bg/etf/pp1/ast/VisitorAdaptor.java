...
public abstract class VisitorAdaptor implements Visitor { 
    ...
    public void visit(Designator_max Designator_max) { visit(); }
    ...
    public void visit(TermRec TermRec) { visit(); }
    public void visit(AddopBase AddopBase) { visit(); }
    ...
    public void visit(AndStart AndStart) { visit(); }
    public void visit(AndTerm AndTerm) { visit(); }
    public void visit(CondTermRestNo CondTermRestNo) { visit(); }
    public void visit(CondTermRestYes CondTermRestYes) { visit(); }
    public void visit(CondTerm CondTerm) { visit(); }
    public void visit(OrCond OrCond) { visit(); }
    public void visit(ConditionRestNo ConditionRestNo) { visit(); }
    public void visit(ConditionRestYes ConditionRestYes) { visit(); }
    public void visit(Condition Condition) { visit(); }
    public void visit(ActParsBase ActParsBase) { visit(); }
    public void visit(ActParsRec ActParsRec) { visit(); }
    ...
    public void visit(FormParsOptNo FormParsOptNo) { visit(); }
    ...
    public void visit(EnumRest_e EnumRest_e) { visit(); }
    public void visit(EnumRestComma EnumRestComma) { visit(); }
    public void visit(EnumField_default EnumField_default) { visit(); }
    public void visit(EnumField_assign EnumField_assign) { visit(); }
    public void visit(EnumClose EnumClose) { visit(); }
    public void visit(EnumOpen EnumOpen) { visit(); }
    ...
    public void visit(ConstRest_e ConstRest_e) { visit(); }
    public void visit(ConstRestComma ConstRestComma) { visit(); }
