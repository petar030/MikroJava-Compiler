...
public class DesignatorRest_more_index extends DesignatorRest {

    private DesignatorRest DesignatorRest;
    private Expr Expr;

    public DesignatorRest_more_index (DesignatorRest DesignatorRest, Expr Expr) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorRest_more_index(\n");
